"""
v-itsm baseline migration — seeds app-scoped data:
  - menu_items where app_id='v-itsm'
  - permission_group_grants for itsm menus
...
def migrate(engine: Engine) -> None:
    run_sql_file(engine, SQL_PATH, label="v-itsm")
