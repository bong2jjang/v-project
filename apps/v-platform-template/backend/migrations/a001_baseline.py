"""
v-platform-template baseline migration — seeds app-scoped data:
  - menu_items where app_id='v-platform-template'
...
def migrate(engine: Engine) -> None:
    run_sql_file(engine, SQL_PATH, label="v-platform-template")
