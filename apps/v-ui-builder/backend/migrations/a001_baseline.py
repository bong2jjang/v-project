"""
v-ui-builder baseline migration — seeds app-scoped data:
  - menu_items where app_id='v-ui-builder'
  - permission_group_grants for ui-builder menus
...
def migrate(engine: Engine) -> None:
    run_sql_file(engine, SQL_PATH, label="v-ui-builder")
