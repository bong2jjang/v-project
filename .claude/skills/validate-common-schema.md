...
```python
# backend/tests/schemas/test_common_message.py
...
```python
# backend/tests/providers/test_slack_provider_schema.py
...
pytest backend/tests/schemas/test_common_message.py -v
...
pytest backend/tests/providers/test_teams_provider_schema.py -v

# 3. 양방향 변환 무결성 테스트
echo "4. 양방향 변환 무결성 검증..."
pytest backend/tests/integration/test_schema_integrity.py -v
