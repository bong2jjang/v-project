...
from app.utils.auth import require_system_admin, require_admin_or_above
...
async def create_company(
    ...
    if (
        ...
        raise HTTPException(400, "회사명 또는 코드가 이미 존재합니다")
...
async def create_department(
    ...
    if existing:
        raise HTTPException(400, "같은 회사 내에 동일한 부서명이 존재합니다")
