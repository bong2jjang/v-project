...
현재 VMS Chat Ops는 기본적인 텍스트 메시지 전송만 지원합니다. 실제 채팅 환경과 동일한 경험을 제공하기 위해 다음 기능들을 개선합니다.
...
### ✅ 1. Matterbridge 스타일 메시지 표시 (2026-04-03 완료)
...
### ✅ 완료된 항목
1. Matterbridge 스타일 메시지 표시 (2026-04-03)
