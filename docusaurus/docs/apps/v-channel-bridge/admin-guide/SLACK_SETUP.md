...
VMS Channel Bridge의 Slack Provider (Socket Mode)를 연동하기 위한 Slack App 설정 방법을 안내합니다.
...
3. App 이름과 워크스페이스를 지정합니다:
   - **App Name**: `VMS Channel Bridge` (원하는 이름)
...
VMS Channel Bridge는 **Socket Mode**를 사용하여 실시간 이벤트를 수신합니다.
